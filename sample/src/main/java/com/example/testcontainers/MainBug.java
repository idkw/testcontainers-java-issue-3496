...
public class MainBug {
	...
	private static final Logger logger = LoggerFactory.getLogger(MainBug.class);

	private static DockerComposeContainer container = new DockerComposeContainer<>(new File(MainBug.class
		.getClassLoader()
